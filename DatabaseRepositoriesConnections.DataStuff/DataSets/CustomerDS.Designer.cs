...
namespace DatabaseRepositoriesConnections.DataStuff.DataSets.CustomerDSTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=localhost,1400;Initial Catalog=Northwind;Persist Security Info=True;U" +
                "ser ID=sa;Password=Dorm2024#;TrustServerCertificate=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM Customer WHERE customerID = @customerId";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@customerId", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Address, City, CompanyName, ContactName, ContactTitle, Country, CustomerID" +
            ...
            this._commandCollection[3].CommandText = @"UPDATE Customers SET 
        ...
        public virtual int Fill(CustomerDS.CustomersDataTable dataTable) {
        ...
        public virtual CustomerDS.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerDS.CustomersDataTable dataTable = new CustomerDS.CustomersDataTable();
        ...
        public virtual int FillByCustomerID(CustomerDS.CustomersDataTable dataTable, string customerId) {
        ...
        public virtual CustomerDS.CustomersDataTable GetDataByCustomerID(string customerId) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((customerId == null)) {
                throw new global::System.ArgumentNullException("customerId");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerDS.CustomersDataTable dataTable) {
        ...
        public virtual int DeleteCustomerByID(object customerId) {
        ...
        public virtual int UpdateCustomerByID(string companyName, string contactName, string contactTitle, string address, string city, string region, string postalCode, string country, string phone, string fax, string customerId) {
            ...
            if ((customerId == null)) {
                ...
                command.Parameters[10].Value = ((string)(customerId));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
